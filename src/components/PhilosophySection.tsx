    ...
    <section className="py-24 md:py-32 px-6 md:px-12">
      <div ref={ref} className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mx-auto">
          As the CEO & Founder of Interactive Photography Workshop Pvt. Ltd. and creator of the trademarked "A Lay Man Approach Towards Photography™", Abhishek has motivated over 3,000 photographers across India with his clean work and revolutionary teaching style. He doesn't just teach — he transforms how you see.
        </p>
      </div>
    </section>
  );
